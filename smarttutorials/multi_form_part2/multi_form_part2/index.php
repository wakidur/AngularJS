...
<form id="loginForm">
    ...
    <div id="firstStep">
	<p>First Step</p>
	   <input id="first_name" name="first_name" class="login-field required" data-msg-required="Please Enter Your First Name" type="text" placeholder="Enter your first name" value="" minlength="5">
	   <br/>
	   <input id="last_name" name="last_name" class="login-field required" type="text" placeholder="Enter Your Last Name" value="" data-msg-required="Please enter your last name" minlength="5">
	    <br/>
	   <input id="email" name="email" class="login-field required email" type="email" placeholder="Enter your Email" value="" data-msg-required="Please Enter Your E-Mail">
	    <br/>
