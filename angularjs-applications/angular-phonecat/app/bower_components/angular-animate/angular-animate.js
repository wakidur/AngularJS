 ...
 */
    var $$AnimateChildrenDirective = ['$interpolate',
    ...
    var $AnimateCssProvider = ['$animateProvider',
    ...
    var $$AnimateJsProvider = ['$animateProvider',
        function($animateProvider) {
    ...
    var $$AnimateQueueProvider = ['$animateProvider',
        function($animateProvider) {
    ...
    var $$AnimationProvider = ['$animateProvider',
        function($animateProvider) {
     ...
     * </example>
     */
    var ngAnimateSwapDirective = ['$animate', '$rootScope',
