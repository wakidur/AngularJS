...
(function(window, angular) {
    ...
    .config(['$provide',
        function($provide) {
            ...
            $provide.decorator('$$animateJs', ['$delegate',
                function($delegate) {
                    var runners = [];
            ...
            $provide.decorator('$animateCss', ['$delegate',
                function($delegate) {
                    var runners = [];
 ...
 */
    ...
    angular.mock.$TimeoutDecorator = ['$delegate', '$browser',
    ...
    angular.mock.$RAFDecorator = ['$delegate',
        function($delegate) {
     ...
     */
    angular.mock.$RootScopeDecorator = ['$delegate',
        function($delegate) {
